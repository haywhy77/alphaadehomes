...
//exit();
 ...
 echo '<script type="text/javascript">window.location.replace("index5.php?htennek007='.$identity.'");</script>';
               }
...
<input type="hidden" class="form-control"   id='index1'  name='index4' value="Commitment to Socio-Economic Development and Environmental Protection">  
</div>  
        ...
        <div class="form-group">  
            ...
            <textarea name="promise4[]" id="editor2" rows="5" class="form-control"></textarea>
        </div> 
        ...
        <div id="filiv" class="form-group">
            ...
            <textarea class="form-control" rows="5" name='doings4[]'></textarea>  
        </div> 
