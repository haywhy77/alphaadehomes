...
for ($i= 0; $i < count($promise6Array); $i++ ) {
 ...
 echo '<script type="text/javascript">window.location.replace("index7.php?htennek007='.$identity.'");</script>';
               }
...
<input type="hidden" class="form-control" id='index1'  name='index6' value="Commitment and Approach to Internal Security and Public Safety">  
</div>  
        ...
        <div class="form-group">  
            ...
            <textarea name="promise6[]" id="editor2" rows="5" class="form-control"></textarea>
        </div> 
        ...
        <div id="filiv" class="form-group">
            ...
            <textarea class="form-control" rows="5" name='doings6[]'></textarea>  
        </div> 
