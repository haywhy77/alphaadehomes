...
for ($i= 0; $i < count($promise5Array); $i++ ) {
 ...
 echo '<script type="text/javascript">window.location.replace("index6.php?htennek007='.$identity.'");</script>';
               }
...
<input type="hidden" class="form-control" id='index1' name='index5' value="Commitment to Education and Social Change">  
</div>  
        ...
        <div class="form-group">  
            ...
            <textarea name="promise5[]" id="editor2" rows="5" class="form-control"></textarea>
        </div> 
        ...
        <div id="filiv" class="form-group">
            ...
            <textarea class="form-control" rows="5" name='doings5[]'></textarea>  
        </div> 
