...
echo '<script type="text/javascript">window.location.replace("index3.php?htennek007='.$identity.'");</script>';
               }
...
<label>Commitment to Poverty and Eradication</label>
<input type="hidden" class="form-control" id='index1' name='index2' value="Commitment to Poverty and Eradication">  
</div>  
        ...
        <div class="form-group">  
            ...
            <textarea name="promise2[]" id="editor2" rows="5" class="form-control"></textarea>
        </div> 
        ...
        <div id="filiv" class="form-group">
            ...
            <textarea class="form-control" rows="5" name='doings2[]'></textarea>  
        </div> 
