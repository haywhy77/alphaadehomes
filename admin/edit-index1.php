...
for ($i= 0; $i < count($promise1Array); $i++ ) {
 ...
 echo '<script type="text/javascript">window.location.replace("edit-index2.php?htennek007='.$identity.'");</script>';
               }
...
<label>'.$index1.'</label>
<input type="hidden" class="form-control"   id="index1"  name="index1" value="'.$index1.'">  
</div>';  
...
echo
        '<div class="form-group">  
            ...
            <textarea name="promise1[]" id="txt" rows="5" value="'.$prom1[$i].'" class="form-control">'.$prom1[$i].'</textarea>
        </div> 
        ...
        <div id="filiv" class="form-group">
            ...
            <textarea class="form-control" rows="5" name="doings1[]">'.$doin1[$i].'</textarea>  
        </div>'; 
