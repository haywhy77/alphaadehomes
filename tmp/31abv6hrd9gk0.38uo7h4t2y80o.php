...
<script type="module" src="<?= ($BASE) ?>/<?= ($ASSETS) ?>/editor/main.js"></script>   -->
<!-- <script type="text/javascript" src="<?= ($BASE) ?>/<?= ($ASSETS) ?>/js/froala_editor.pkgd.min.js"></script>
<script>
   var editor = new FroalaEditor('textarea');
</script> -->

<script src="https://cdn.jsdelivr.net/npm/quill@2.0.2/dist/quill.js"></script>
<!-- <script src="<?= ($BASE) ?>/<?= ($ASSETS) ?>/js/quill.textarea.js"></script> -->
</body>
</html>