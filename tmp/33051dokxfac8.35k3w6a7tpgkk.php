            ...
            <div class="page__content" id="page-content">
                ...
                <div class="important-container login-container">
                    ...
                    <div class="content">
                        ...
                        <br><br><p><br><br>
                        <p class="caption text-center margin-bottom-30">Welcome to <?= ($business) ?></p>
...
" ?>
                ...
                <div class="content d-none d-lg-block" id="content" style="background: url(<?= ($BASE) ?>/<?= ($ASSETS) ?>/assets/img/backgrounds/admin.png) left center no-repeat; width: 100vw; height: 100vh; background-size: cover;">
                    <div style="display: flex; flex-direction: column; align-items: center; gap: 10px; margin-top:15%;">
                        <a href="/" class="logo-holder logo-holder--lg logo-holder--wide" >
                            <div class="logo-text">
                                <strong class="text-primary">
                                    <img src="<?= ($BASE) ?>/ui/img/logo1.png" style="width:250px;" />
                                </strong>
                            </div>
                        </a>
                        <div style="color: #0A1850; font-size: 5em; margin-top: 30%;">Know Dem WELL!!!</div>
                    </div>
                </div>
