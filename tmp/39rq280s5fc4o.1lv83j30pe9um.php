...
<body>
    ...
    <!--/progress-->
    <section class="w3l-servicesblock w3l-servicesblock1 py-3" id="progress">
        <div class="container py-lg-3 py-md-4 py-2">
            <div class="row">
                <div class="col-lg-6 mb-lg-0 mb-5 pe-lg-5">
                    <h5 class="title-subw3hny mb-1">Core Values</h5>
                    <h3 class="title-w3l">The Core Company Values</h3>
                    <p class="mt-md-4 mt-3"><strong>Integrity</strong> is the foundation of our business. We believe that trust is earned through consistent, ethical behavior and accountability. Our team is committed to being transparent in all our dealings, providing honest assessments, and maintaining confidentiality. We uphold the highest standards of professionalism, ensuring that our clients can rely on us to act in their best interests.
                    </p>
                    <p class="mt-md-4 mt-3"><strong>Excellence</strong> is at the heart of everything we do. We aim to exceed expectations by delivering top-notch service in every transaction. Our team is composed of skilled professionals who continuously seek to improve their knowledge and expertise.
                    </p>
                    <p class="mt-md-4 mt-3"><strong>Innovation</strong> drives our progress and sets us apart in the real estate market. We embrace cutting-edge technology and creative solutions to enhance the buying and selling experience for our clients.
                    </p>
    ...
    <!--/w3l-index3-->
    <section class="w3l-index-about py-2" id="about2">
    ...
    <!--//w3l-index3-->
    <!--/w3-grids-->
    <section class="w3l-passion-mid-sec home-phny py-1">
    ...
    <!--//w3-grids-->
    <!--/faq-section-->
    <div class="w3l-faq-block py-1" id="faq">
        <div class="container content-gd py-lg-1">
            <div class="row mt-3">
