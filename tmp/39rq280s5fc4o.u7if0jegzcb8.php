            ...
            <div class="witemshny-grids row">
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <a href="<?= ($BASE) ?>/properties/sale" class="d-block zoom"><img src="<?= ($BASE) ?>/ui/frontend/images/d1.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="<?= ($BASE) ?>/properties/sale">Buying a Home</a>
                    </h4>
                </div>
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <a href="<?= ($BASE) ?>/properties/rent" class="d-block zoom"><img src="<?= ($BASE) ?>/ui/frontend/images/d2.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="<?= ($BASE) ?>/properties/rent">Renting a Home</a>
                    </h4>
                </div>
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <a href="<?= ($BASE) ?>/properties/sale" class="d-block zoom"><img src="<?= ($BASE) ?>/ui/frontend/images/d3.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="<?= ($BASE) ?>/properties/sale">Sell Your Property</a>
                    </h4>
                </div>
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <a href="<?= ($BASE) ?>/properties/lease" class="d-block zoom"><img src="<?= ($BASE) ?>/ui/frontend/images/d4.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="<?= ($BASE) ?>/properties/lease">Leasing a space</a>
                    </h4>
                </div>
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <a href="<?= ($BASE) ?>/properties/sale" class="d-block zoom"><img src="<?= ($BASE) ?>/ui/frontend/images/d5.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="<?= ($BASE) ?>/properties/sale">Buying Spaces</a>
                    </h4>
                </div>
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <a href="<?= ($BASE) ?>/properties/airbnb" class="d-block zoom"><img src="<?= ($BASE) ?>/ui/frontend/images/d6.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="<?= ($BASE) ?>/properties/airbnb">AirBnB</a>
                    </h4>
                </div>
            </div>
            <!--//row-1-->
            ...
            <div class="row">
                <div class="col-md-6 mt-md-0">
                    <div class="grids3-info position-relative">
                        <a href="<?= ($BASE) ?>/properties/sale" class="d-block zoom"><img src="<?= ($BASE) ?>/ui/frontend/images/banner1.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="w3-grids3-info">
                            <h4 class="gdnhy-1"><a href="<?= ($BASE) ?>/properties/sale">Buy a Commercial<br>Property</a>
                                <a class="w3item-link btn btn-style mt-4" href="<?= ($BASE) ?>/properties/sale">
                ...
                <div class="col-md-6 mt-md-0 mt-4 grids3-info2">
                    <div class="grids3-info position-relative">
                        <a href="<?= ($BASE) ?>/properties/lease" class="d-block zoom"><img src="<?= ($BASE) ?>/ui/frontend/images/banner2.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="w3-grids3-info second">
                            <h4 class="gdnhy-1"><a href="<?= ($BASE) ?>/properties/lease">Lease a Commercial<br>Property</a>
                                <a class="w3item-link btn btn-style mt-4" href="<?= ($BASE) ?>/properties/lease">
                                    Explore Property <i class="fas fa-angle-double-right ms-2"></i>
                                </a>
                            </h4>
        ...
        <div class="container py-md-5 py-3">
            <div class="row bottom-ab-grids">
                ...
                <div class="w3ab-left-top col-lg-6 mt-lg-0 mt-5 ps-lg-5">
                    ...
                    <a href="<?= ($BASE) ?>/properties/sale" class="btn btn-style btn-primary mt-4">Explore Buying <i class="fas fa-angle-double-right ms-2"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="row w3l-passion-mid-grids">
                    <div class="col-lg-6 passion-grid-item-info pe-lg-5 mb-lg-0 mb-5">
                        ...
                        <a href="<?= ($BASE) ?>/properties/rent" class="btn btn-style btn-primary mt-lg-5 mt-4 me-2">Rent a Home<i class="fas fa-angle-double-right ms-2"></i></a>
