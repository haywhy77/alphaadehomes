        ...
        <div class="container">
            <div class="w3l-clients">
                <div id="owl-demo1" class="owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <div class="row no-gutters m-lg-0 test-w3hny-info">
                            <div class="col-lg-5 w3l-left-img2">
                            </div>
                            <div class="col-lg-7 w3l-right-info">
                                <div class="testimonial-content">
                                    <div class="testimonial">
                    ...
                    <div class="item">
                        <div class="row no-gutters m-lg-0 test-w3hny-info">
                            <div class="col-lg-5 w3l-left-img3">
                            </div>
                            <div class="col-lg-7 w3l-right-info">
                                <div class="testimonial-content">
                                    <div class="testimonial">
                    ...
                    <div class="item">
                        <div class="row no-gutters m-lg-0 test-w3hny-info">
                            <div class="col-lg-5 w3l-left-img4">
                            </div>
                            <div class="col-lg-7 w3l-right-info">
                                <div class="testimonial-content">
                                    <div class="testimonial">
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="blog.html" class="zoom d-block">
                                    <img class="card-img-bottom d-block" src="<?= ($BASE) ?>/ui/frontend/images/g3.jpg" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body blog-details">

                                <a href="blog.html" class="blog-desc">Private Contemporary Home Balancing Openness</a>
                                <p>Lorem ipsum viverra feugiat. Pellen tesque libero ut justo.</p>
                            </div>
                            <div class="card-footer">
                                <div class="author align-items-center">
                                    <a href="#author" class="post-author">
                                        <img src="<?= ($BASE) ?>/ui/frontend/images/team1.jpg" alt="" class="img-fluid rounded-circle">
                                    </a>
                                    <ul class="blog-meta">
                                        <li>
                    ...
                    <div class="col-lg-4 col-md-6 item mt-md-0 mt-5">
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="blog.html" class="zoom d-block">
                                    <img class="card-img-bottom d-block" src="<?= ($BASE) ?>/ui/frontend/images/g4.jpg" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body blog-details">

                                <a href="blog.html" class="blog-desc">How Does A Designer Home Look Like</a>
                                <p>Lorem ipsum viverra feugiat. Pellen tesque libero ut justo.</p>
                            </div>
                            <div class="card-footer">
                                <div class="author align-items-center">
                                    <a href="#author" class="post-author">
                                        <img src="<?= ($BASE) ?>/ui/frontend/images/team2.jpg" alt="" class="img-fluid rounded-circle">
                                    </a>
                                    <ul class="blog-meta">
                                        <li>
                    ...
                    <div class="col-lg-4 col-md-6 item mt-lg-0 mt-5">
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="blog.html" class="zoom d-block">
                                    <img class="card-img-bottom d-block" src="<?= ($BASE) ?>/ui/frontend/images/g2.jpg" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body blog-details">
                            ...
                            <div class="card-footer">
                                <div class="author align-items-center">
                                    <a href="#author" class="post-author">
                                        <img src="<?= ($BASE) ?>/ui/frontend/images/team3.jpg" alt="" class="img-fluid rounded-circle">
                                    </a>
                                    <ul class="blog-meta">
                                        <li>
