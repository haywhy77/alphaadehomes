...
<div class="inner-banner">
    <section class="w3l-breadcrumb py-5">
        <div class="container py-lg-5 py-md-3">
            <h2 class="title">Know Dem Well Profile</h2>
        </div>
    </section>
</div>
<!-- banner bottom shape -->
...
<section class="w3l-aboutblock1 py-5" id="about">
    <div class="container py-lg-5 py-md-3">
        <div class="row">
            <div class="col-lg-6">
                <h3 class="title-big" style="color:#007bff;"><?php echo $row['fullname']; ?></h3>
                <h5 class="title-small mt-2">Political Party: <?php echo $row['party']; ?></h5>
                ...
                <h5 class="title-small">Date of Birth: <?php echo $dob.$row['dob_2']; ?></h5>
                <h3 class="title mt-4" style="color:#007bff;">Manifesto</h3>
                <p class="mt-2"><?php echo $row['manifesto']; ?></p>
                <h3 class="title mt-4" style="color:#007bff;">Ideology</h3>
                <p class="mt-2"><?php echo $row['ideology']; ?></p>
                <h3 class="title mt-4"  style="color:#007bff;">Verdict</h3> 
                <p class="mt-2"><?php echo $row['verdict']; ?></p>
            </div>
                ...
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title">1. <span style="color:#007bff;">Commitment to Democracy, Human Rights, and Gender Equality</span></h3>
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title"><font color='#fd7e14'>&emsp; Actual Doings</font></h3><?php echo $row['index1_doings']; ?></p>
                        </div>
                    </div>
                </div>
                <!--//author-card-->
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title">2. <span style="color:#007bff;">Commitment to Poverty Eradication</span></h3>
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title"><font color='#fd7e14'>&emsp; Actual Doings</font></h3><?php echo $row['index2_doings']; ?></p>
                        </div>
                    </div>
                </div>
                <!--//author-card-->
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title">3. <span style="color:#007bff;">Commitment to Ending Corruption in Public Offices and Society</span></h3>
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title"><font color='#fd7e14'>&emsp; Actual Doings</font></h3><?php echo $row['index3_doings']; ?></p>
                        </div>
                    </div>
                </div>
                <!--//author-card-->
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title">4. <span style="color:#007bff;">Commitment to Socio-Economic Development and Environmental Protection</span></h3>
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title"><font color='#fd7e14'>&emsp; Actual Doings</font></h3><?php echo $row['index4_doings']; ?></p>
                        </div>
                    </div>
                </div>
                <!--//author-card-->
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title">5. <span style="color:#007bff;">ommitment to Education and Social Change</span></h3>
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title"><font color='#fd7e14'>&emsp; Actual Doings</font></h3><?php echo $row['index5_doings']; ?></p>
                        </div>
                    </div>
                </div>
                <!--//author-card-->
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title">6. <span style="color:#007bff;">Commitment and Approach to Internal Security and Public Safety</span></h3>
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title"><font color='#fd7e14'>&emsp; Actual Doings</font></h3><?php echo $row['index6_doings']; ?></p>
                        </div>
                    </div>
                </div>
                <!--//author-card-->
...
<section class="blog-post-main w3l-homeblock1">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title">7. <span style="color:#007bff;">Commitment and Approach to Peace and Conflict Resolution</span></h3>
...
<section class="blog-post-main w3l-homeblock1">
    <!--/blog-post-->
    <div class="blog-content-inf pb-3">
   ...
   <!--//author-card-->
                <div class="author-card mt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 mt-md-0 mt-4">
                            <h3 class="mb-3 title"><font color='#fd7e14'>&emsp; Actual Doings</font></h3><?php echo $row['index7_doings']; ?></p>
                        </div>
                    </div>
                </div>
                <!--//author-card-->
